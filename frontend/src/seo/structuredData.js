...
export const organizationLd = () => ({
    ...
    url: SITE.url,
    logo: SITE.logo,
    description: 'India-based web development and AI integration agency. Websites, mobile apps, WhatsApp chatbots, AI agents, custom CRM, and e-commerce for Indian businesses.',
    knowsAbout: [
